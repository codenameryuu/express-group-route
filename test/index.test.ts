...
describe("express-route-grouping", () => {
  ...
  describe("group", () => {
    it("should be register a group", () => {
      ...
      // Assert
      sandbox.assert.calledOnceWithExactly(registerSpy, sinon.match.instanceOf(RouteGroup));
    ...
    it("should be register nested route groups", () => {
      ...
      // Assert
      sandbox.assert.calledOnceWithMatch(registerSpy, sinon.match.instanceOf(RouteGroup));
