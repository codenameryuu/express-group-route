# @codenameryuu/express-group-route
...
```bash
yarn add @codenameryuu/express-group-route
```
...
This project is [MIT](https://github.com/codenameryuu/express-group-route/blob/master/LICENSE.md) licensed.
